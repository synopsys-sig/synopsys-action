...
export const BLACKDUCK_FIXPR_FILTER_BY_KEY = 'blackduck_fixpr_filter_by'
export const BLACKDUCK_FIXPR_FILTER_SEVERITIES_KEY = 'blackduck_fixpr_filter_severities'
export const BLACKDUCK_FIXPR_LONG_TERM_GUIDANCE_KEY = 'blackduck_fixpr_useLongTermUpgradeGuidance'
