...
export const BLACKDUCK_FIXPR_FILTER_BY = getInput(constants.BLACKDUCK_FIXPR_FILTER_BY_KEY)?.trim() || ''
export const BLACKDUCK_FIXPR_FILTER_SEVERITIES = getInput(constants.BLACKDUCK_FIXPR_FILTER_SEVERITIES_KEY)?.trim() || ''
export const BLACKDUCK_FIXPR_LONG_TERM_GUIDANCE = getInput(constants.BLACKDUCK_FIXPR_LONG_TERM_GUIDANCE_KEY)?.trim() || ''
