...
export const BLACKDUCK_REPORTS_SARIF_ISSUE_TYPES = getInput(constants.BLACKDUCK_REPORTS_SARIF_ISSUE_TYPES_KEY)?.trim() || ''
...
export const UPLOAD_SARIF_RESULT = getInput(constants.UPLOAD_SARIF_RESULT_KEY)?.trim() || ''
